...
@app.route('/events/titan-lab-tours')
def code_camp():
    return render_template('events/titan-lab-tours.html', bannerurl=url_for('static', filename='img/events/code-camp.jpg'), title='Titan Lab Tours')
